...
df = df_data_grabber('../Data/sect1_hh_w3.dta', idxvars, convert_categoricals=False, **myvars)

# Create pid from individual_id
from lsms_library.local_tools import get_dataframe
df_temp = get_dataframe('../Data/sect1_hh_w3.dta', convert_categoricals=False)
...
df.index = pd.MultiIndex.from_tuples(
    [('2015-16',) + idx for idx in df.index],
